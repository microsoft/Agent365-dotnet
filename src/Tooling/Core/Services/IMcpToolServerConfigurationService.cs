...
namespace Microsoft.Agents.A365.Tooling.Services
{
    ...
    public interface IMcpToolServerConfigurationService
    {
        ...
        Task<List<MCPServerConfig>> ListToolServersAsync(string agentInstanceId, string environmentId, string authToken);
        ...
        Task<IList<McpClientTool>> GetMcpClientToolsAsync(ITurnContext turnContext, MCPServerConfig mCPServerConfig, string environmentId, string authToken);
    }
}
