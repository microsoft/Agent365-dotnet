# Microsoft Agents 365 SDK - SemanticKernel Tooling

This library provides integration between Microsoft Agents 365 and SemanticKernel, enabling you to add MCP (Model Context Protocol) tool servers to your SemanticKernel agents.
