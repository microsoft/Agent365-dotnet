...
namespace Microsoft.Agents.A365.Observability.Runtime.Tracing.Exporters
{
    ...
    public sealed class Agent365ExporterAsync : BaseExporterAsync<Activity>
    {
        ...
        /// <summary>
        /// Exports a batch of OpenTelemetry activities to the Microsoft Agents A365 observability platform asynchronously.
        /// </summary>
        ...
        private List<(string TenantId, string AgentId, List<Activity> Activities)> PartitionByIdentity(IReadOnlyCollection<Activity> batch)
        {
