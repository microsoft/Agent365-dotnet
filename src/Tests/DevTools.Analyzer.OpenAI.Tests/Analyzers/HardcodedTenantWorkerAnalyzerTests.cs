...
{
    /// <summary>
    /// Test class for HardcodedTenantWorkerAnalyzer.
    /// </summary>
    public class HardcodedTenantWorkerAnalyzerTests : AnalyzerTestBase<HardcodedTenantWorkerAnalyzer>
    {
        [Fact]
        public void Analyzer_HasCorrectDiagnosticIds()
        {
            ...
            Assert.Equal(AnalyzerConstants.DiagnosticIds.HardcodedTenantWorkerPrevention, diagnosticId);
        }
        ...
        {
            var descriptor = DiagnosticDescriptorFactory.HardcodedTenantWorkerPrevention;
