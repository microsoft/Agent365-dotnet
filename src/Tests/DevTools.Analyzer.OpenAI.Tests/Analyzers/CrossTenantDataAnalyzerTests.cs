...
{
    /// <summary>
    /// Test class for CrossTenantDataAnalyzer.
    /// </summary>
    public class CrossTenantDataAnalyzerTests : AnalyzerTestBase<CrossTenantDataAnalyzer>
    {
        [Fact]
        public void Analyzer_HasCorrectDiagnosticIds()
        {
            ...
            Assert.Equal(AnalyzerConstants.DiagnosticIds.CrossTenantDataAccessPrevention, diagnosticId);
        }
        ...
        {
            var descriptor = DiagnosticDescriptorFactory.CrossTenantDataAccessPrevention;
