...
namespace Microsoft.Agents.A365.Observability.Runtime.Tests.IntegrationTests
{
    ...
    public class Agent365ExporterE2ETests
    {
        ...
        #region Web Host Builder Tests
        [TestMethod]
        public async Task AddTracing_And_InvokeAgentScope_ExporterMakesExpectedRequest_UsingWebHostBuilder()
        {
            // Arrange
            this.SetupExporterTest(this.CreateTestServiceProviderUsingWebHostBuilder);
            this._receivedRequest = false;
            this._receivedContent = null;
            var expectedAgentType = AgentType.EntraEmbodied;
            var expectedAgentDetails = new AgentDetails(
        ...
        private void SetupExporterTest(Func<HttpClient, ServiceProvider>? providerFactory = null)
        {
            ...
            var factory = providerFactory ?? this.CreateTestServiceProvider;
            this._provider = factory(httpClient);
        }
    }
}
