...
namespace Microsoft.Agents.A365.Runtime.Utils
{
    ...
    public static class Utility
    {
        ...
        /// </summary>
        /// <param name="httpClientFactory">The IHttpClientFactory to create the HttpClient instance. If null, creates a new HttpClient directly (not recommended for production use).</param>
        ...
        public static HttpClient GetDefaultHttpClient(IHttpClientFactory? httpClientFactory = null, IUserAgentConfiguration? userAgentConfiguration = null, int timeoutSeconds = 30)
        {
