...
{
    /// <summary>
    /// Test class for AgentConstructionAnalyzer.
    /// Tests detection of agent construction violations.
    /// </summary>
    public class AgentConstructionAnalyzerTests : AnalyzerTestBase<AgentConstructionAnalyzer>
    {
        ...
        public void Analyzer_HasCorrectDiagnosticIds()
        {
            ...
            Assert.Equal(AnalyzerConstants.DiagnosticIds.AgentConstructionValidation, diagnosticId);
        }
        ...
        {
            var descriptor = DiagnosticDescriptorFactory.AgentConstructionValidation;
